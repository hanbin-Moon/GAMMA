...
$handle = fopen("/Users/admin/Desktop/P.txt", "r");
 if ($handle) {
	  $i=0;
    while (!feof($handle)) {
        $buffer[100] = fgetss($handle, 1024);
    }
    fclose($handle);
 }

//scp 연결 부분!!
$connection2 = ssh2_connect('210.94.194.55', 22);
ssh2_auth_password($connection2, 'GAMMA', 'gamma1234');
ssh2_scp_send($connection2, $uploaded_file_copy, '/home/GAMMA', 0644);
